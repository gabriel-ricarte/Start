jQuery(function($) {
  //listeners de movimento de tarefas no kanban
        ...
        panelList3.sortable({
            connectWith: ".connectedSortable",
            update: function(event,ui) {
                       movido(ui.item[0].id,val3,5);

            }
        }).disableSelection();
        var panelList4 = $('#draggablePanelList5');
        var val4 = document.getElementById('draggablePanelList5').getAttribute('data-value');
        panelList4.sortable({
            connectWith: ".connectedSortable",
            update: function(event,ui) {
                       movido(ui.item[0].id,val4,2);

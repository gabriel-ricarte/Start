							...
							<div class="col-lg-8">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-4">CRIE SEU PRIMEIRO KANBAN ! <button class="btn btn-danger btn-circle" data-toggle="popover" title="Campos Obrigatórios" data-content="Todos os campos com texto são obrigatórios"><span class="fa fa-info"></span></button></h1>
									</div>
